...
+(instancetype)service {
    ...
    NSDictionary * credentials = [NSDictionary dictionaryWithObjectsAndKeys:@"GoogleDriveSwipeIn", @"kKeychainItemName", @"403565626188-dvusqqv5cc8o2r44dskinvhchq4i50qd.apps.googleusercontent.com", @"kClientID", nil];
